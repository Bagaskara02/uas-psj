...
// --- COMPONENT: SPLASH SCREEN (LOADING) ---
const SplashScreen = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#FDFBF7] flex flex-col items-center justify-center font-ui">
      <div className="mb-6 relative">
        <Shield size={64} className="text-stone-900" strokeWidth={1.5} />
        <div className="absolute inset-0 flex items-center justify-center">
          <Lock size={24} className="text-red-600 animate-pulse" />
        </div>
      </div>
      <h1 className="text-2xl font-display font-bold text-stone-900 mb-2 tracking-tight">
        CYBER<span className="text-red-600">REPORT</span>
      </h1>
      <p className="text-xs uppercase tracking-[0.3em] text-stone-400 mb-8">Article Report by Bagaskara</p>
      ...
      <p className="mt-4 text-xs font-mono text-stone-500">Loading modules... {progress}%</p>
    </div>
  );
};
...
const App = () => {
  ...
  // --- RENDER SPLASH SCREEN JIKA MASIH LOADING ---
  if (loading) {
    return <SplashScreen onComplete={() => setLoading(false)} />;
  }

  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#1a1a1a] selection:bg-red-900 selection:text-white overflow-x-hidden animate-in fade-in duration-700">
      ...
      <main className="pt-28 pb-20 px-4 md:px-6 max-w-7xl mx-auto">
        <header className="relative rounded-[30px] md:rounded-[40px] overflow-hidden bg-stone-900 mb-10 md:mb-24 group min-h-[50vh] md:min-h-[60vh] flex items-center justify-center animate-in zoom-in-95 duration-1000">
           ...
           <div className="relative z-10 max-w-4xl mx-auto px-6 text-center py-12 md:py-20">
               <div className="flex items-center justify-center gap-3 mb-6 md:mb-8 font-ui animate-fade-in delay-100">
               ...
               <h1 className="text-4xl md:text-7xl lg:text-8xl font-black text-white leading-[0.95] tracking-tight mb-6 md:mb-8 drop-shadow-lg animate-in slide-in-from-bottom-10 duration-1000 delay-200">
                 Darurat Kebocoran <br/> <i className="font-serif font-medium text-red-500">Data Nasional.</i>
               </h1>
               <p className="text-base md:text-2xl text-stone-200 font-serif leading-relaxed max-w-3xl mx-auto italic border-l-4 border-red-600/50 pl-4 md:pl-0 md:border-none drop-shadow-md text-left md:text-center animate-in slide-in-from-bottom-5 duration-1000 delay-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
           ...
           <aside className="hidden lg:block lg:col-span-3">
              <div className="sticky top-32 animate-in slide-in-from-left-5 duration-1000">
